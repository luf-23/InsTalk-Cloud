package org.instalk.cloud.instalksocialservice.friendship.controller;
...
import org.instalk.cloud.instalksocialservice.friendship.service.FriendshipService;
...
public class FrontController {
    ...
    public Result sendFriendshipRequest(@RequestParam Long id) {
        ...
        if (userFeignClient.getUserById( id) == null) return Result.error("用户不存�?);
